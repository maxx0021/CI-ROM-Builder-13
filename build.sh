...
git clone --depth=1 https://github.com/Maxx12211/android_device_xiaomi_rova.git -b tmp/alpha device/xiaomi/rova
git clone --depth=1 https://github.com/Maxx12211/android_vendor_xiaomi_rova.git -b alpha-13 vendor/xiaomi/rova
git clone --depth=1 https://github.com/Maxx12211/android_kernel_xiaomi_rova.git -b alpha-13 kernel/xiaomi/rova
